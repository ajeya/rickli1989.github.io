...
var path = {
	...
	minify: 'dist/**/*.js',
	assets: ['./src/**/*.css', './src/**/*.svg', './src/**/*.woff', './src/**/*.woff2', './src/**/*.ttf', './src/**/*.png', './src/**/*.ico', './src/**/*.gif', './src/**/*.jpg', './src/**/*.eot'],
	json: './src/**/*.json',
	index: './src/index.tpl.html',
	watch: './src/**',
	maincss: './src/app/stylesheets/app/app.css',
	maincssOutput: './src/app/stylesheets/app/',
...
gulp.task('autoprefixer', function () {
    return gulp.src(path.maincss)
        .pipe(autoprefixer({
            browsers: ['last 2 versions'],
            cascade: false
        }))
        .pipe(gulp.dest(path.maincssOutput));
});

gulp.task('compile', function(callback) {
	return runSequence(['less', 'autoprefixer', 'html', 'babel', 'json', 'assets'], callback);
});
